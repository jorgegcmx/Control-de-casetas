...
<div class="row" id="main">
  ...
  ?>
                                                                    <tr>
                                                                        <td><small><?php echo  $tran->Loteid; ?>
                                                                            </small> </td>
                                                                        <td><small><?php echo  $tran->TotalCantSal; ?></small>
                                                                        </td>
                                                                        <td><small><?php echo  $tran->TotalCantEnt; ?></small>
                                                                        </td>
                                                                        <td><small>
                                                                                <?php 
    ...
    ?>
                                                                            ...
                                                                            <lotestranferencia
                                                                                lotetras="<?php echo trim($tran->LotSalInc); ?>">
                                                                            </lotestranferencia>
    ...
    ?> </small>
                                                                            <lotestranferencia_entrada
                                                                                lotetras="<?php echo trim($tran->LoteEntGran); ?>">
                                                                            </lotestranferencia_entrada>
                                                                        </td>
     ...
     if(substr($tran->LotAjxMermaEnt,0,3)==000){
       ...
       echo"  <span class='badge bg-danger'>error</span>";
                                                                            ...
                                                                            <lotestranferencia_merma
                                                                                lotetras="<?php echo trim($tran->LotAjxMermaEnt); ?>">
                                                                            </lotestranferencia_merma>
                                                                        </td>
    ...
    ?> </small>
                                                                            <lotestranferencia
                                                                                lotetras="<?php echo trim($tran->LoteSalpvIni); ?>">
                                                                            </lotestranferencia>
                                                                        </td>
                                                                        <td><small>
    ...
    ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><small><b><?php echo  $suma_lotes_Sal ?>
                                                                                </b> </small> </td>
                                                                        <td><small><b><?php echo  $suma_lotes_transferencia ?>
                                                                                </b></small> </td>
    ...
    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="5">
                                                                ...
                                                                <carton
                                                                    idcaseta="<?php echo trim($car->NumIDCaseta); ?>"
